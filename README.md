...
- `docs/frontend-libs-2026.md` — 23 类 / 340 候选对比表（第一批 §1–§15 219 个，第二批 §16–§23 121 个新增 + 4 个对照）、四象限结论、风险清单、链接索引（实查日期 2026-09-05）
...
- `scripts/items_round1.py`、`scripts/items_round2.py` — 候选清单（`ITEMS = [(cat, name, github_repo, npm_pkg), ...]`）
